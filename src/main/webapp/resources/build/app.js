...
var _Notes = require('./collections/Notes');
...
exports.default = _vendor.Marionette.Application.extend({
  onStart: function onStart() {
    ...
    var collection = new _Notes2.default();
    var layout = new _Layout2.default({ collection: collection });
    layout.render();
    var mainController = new _Controller2.default({ layout: layout });
    var router = new _Router2.default({ controller: mainController });
    if (_vendor.Backbone.history) {
      console.log("Backbone history start");
      _vendor.Backbone.history.start({ pushState: false, root: "/" });
    }
    if (_vendor.Backbone.history.fragment === '') {
      _vendor.Backbone.history.navigate('/service-note', true);
    }
  }
});

},{"../vendor/vendor":27,"./Controller":2,"./Router":4,"./collections/Notes":5,"./views/Layout":16}],2:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Marionette.Object.extend({
...
},{"../vendor/vendor":27}],3:[function(require,module,exports){
'use strict';
...
},{"../vendor/vendor":27,"./App":1}],4:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Marionette.AppRouter.extend({
    controller: null,
    appRoutes: {
...
},{"../vendor/vendor":27}],5:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Backbone.Collection.extend({
    url: '/Note/',
    model: _Note2.default,
    initialize: function initialize() {
        this.on('model:push', this.pushModel);
        this.pushModel();
    },
    pushModel: function pushModel() {
        console.log("notes fetch");
        this.fetch({
            success: function success() {
                console.log("collection:fetch");
                _vendor.Radio.channel('basic').trigger('collection:fetch');
            }
        });
    }
...
},{"../../vendor/vendor":27,"../models/Note":6}],6:[function(require,module,exports){
"use strict";
...
exports.default = _vendor.Backbone.Model.extend({
    urlRoot: "/Note/",
...
},{"../../vendor/vendor":27}],7:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<span class="close cancel">×</span> <h4 style="margin-bottom: 25px">Are you sure you want to delete the note?</h4> <hr> <button style="width: 110px" type="button" class="btn btn-outline-primary confirmDelete">Delete</button> <button style="width: 110px" type="button" class="btn btn-outline-warning cancel">Cancel</button>';
}
return __p;
};

},{"underscore":26}],8:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<a class="navbar-brand" href="/"> <img src="https://getbootstrap.com/assets/brand/bootstrap-solid.svg" width="30" height="30" class="d-inline-block align-top" alt="logo"> Naumen Test </a> <div class="collapse navbar-collapse" id="navbarCollapse"> <ul class="nav nav-tabs"> <li class="nav-item"> <a id="show" class="nav-link ';
 if (active == 'show') { 
__p+=' active';
 } 
__p+='" href="/#service-note">Notes</a> </li> <li class="nav-item"> <a id="add" class="nav-link ';
 if (active == 'add') { 
__p+=' active';
 } 
__p+='" href="/#service-note/add">Add notes</a> </li> </ul> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<nav id="header" class="navbar navbar-expand-lg navbar-light bg-light"> </nav> <section id="main" class="overview"> <div class="row"></div> </section> <div id="notification"></div> <div class="custom-modal" style="display:none" id="modal"> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<th scope="row"> <i class="fa fa-window-close-o" aria-hidden="true"></i> </th> <td>'+
...
},{"underscore":26}],11:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row justify-content-center info new-object-form"> <div class="col-lg-5"> <h4>Add entity</h4> <div class="card text-center card-form"> <div class="card-body"> <h5>Note</h5> <form> <div class="form-group"> <input value="'+
((__t=( name ))==null?'':_.escape(__t))+
'" id="name" type="text" class="note form-control form-control-lg" placeholder="Name"> </div> <div class="form-group"> <input value="'+
((__t=( content ))==null?'':_.escape(__t))+
'" id="content" type="text" class="note form-control form-control-lg" placeholder="Content"> </div> <input id="submit" type="submit" value="Save entity" class="btn btn-outline-dark btn-block"> </form> </div> </div> </div> </div>';
}
return __p;
};

},{"underscore":26}],12:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="col-sm-12"> <div class="top-panel"> <div style="height:100%; margin-bottom: 10px"> <button style="padding: 0.6rem 0.75rem" class="btn search btn-success">Search</button> <input id="search" type="text" class="form-control form-control-lg" placeholder="Input name or content"> </div> <i class="fa fa-refresh" aria-hidden="true"></i> </div> <table class="table"> <thead> <tr> <th> </th> <th>Note ID</th> <th>Note name</th> <th>Note content</th> </tr> </thead> <tbody></tbody> </table> <p id="count">Note count: '+
...
},{"underscore":26}],13:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="notification-body notification-'+
((__t=(type))==null?'':__t)+
'"> <div class="notification-icon"></div> <div class="notification-message">'+
((__t=( message ))==null?'':__t)+
'</div> <button type="button" class="close dismiss" aria-hidden="true"></button> </div>';
}
return __p;
};
...
var _noteAdd = require('../templates/noteAdd.html');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    updateCollection: function updateCollection() {
        ...
        var model = new _Note2.default();
        model.set({ "message": "Note is created" });
        model.set({ "type": "success" });
        _vendor.Radio.channel('basic').trigger('notification:show', { model: model });
    ...
    invalid: function invalid(options) {
        var model = new _vendor.Backbone.Model();
...
},{"../../vendor/vendor":27,"../models/Note":6,"../templates/noteAdd.html":11}],15:[function(require,module,exports){
'use strict';
...
var _header = require('../templates/header.html');
...
exports.default = _vendor.Marionette.View.extend({
        ...
        el: "#header",
        initialize: function initialize(options) {
                this.model = new _vendor.Backbone.Model();
                this.model.set({ "active": options.active });
        }
});

},{"../../vendor/vendor":27,"../templates/header.html":8}],16:[function(require,module,exports){
'use strict';
...
var _layout = require('../templates/layout.html');
...
var _NotesLayout = require('./NotesLayout');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    initialize: function initialize() {
        ...
        _vendor.Radio.channel('basic').on('modal:show', this.showModal, this);
        _vendor.Radio.channel('basic').on('notification:close', this.closeNotification, this);
        _vendor.Radio.channel('basic').on('notification:show', this.showNotification, this);
    },
    showNotes: function showNotes() {
        var header = new _Head2.default({ active: "show" });
        header.render();
        var main = this.getChildView("main");
        if (main) {
            main.destroy();
        }
        this.showChildView("main", new _NotesLayout2.default({ collection: this.collection }));
        console.log("layout showNotes...");
    },
    addNote: function addNote() {
        var header = new _Head2.default({ active: "add" });
        header.render();
        this.showChildView("main", new _AddNote2.default({ collection: this.collection }));
        console.log("layout addNote...");
    },
    showModal: function showModal(options) {
        console.log("showModal");
        this.showChildView("modal", new _Modal2.default(options));
    },
    showNotification: function showNotification(options) {
        console.log("show notification");
        this.showChildView("notification", new _Notification2.default(options));
        $("#notification").show();
    },
...
},{"../../vendor/vendor":27,"../templates/layout.html":9,"./AddNote":14,"./Head":15,"./Modal":17,"./NotesLayout":20,"./Notification":21}],17:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Marionette.View.extend({
    ...
    close: function close() {
        (0, _vendor.$)('#modal').hide();
        (0, _vendor.$)('body').css({ 'overflow': 'auto' });
        this.destroy();
    },
    ...
    onRender: function onRender() {
        (0, _vendor.$)('body').css({ 'overflow': 'hidden' });
        (0, _vendor.$)('#modal').show();
    }
});

},{"../../vendor/vendor":27}],18:[function(require,module,exports){
'use strict';
...
var _note = require('../templates/note.html');

var _note2 = _interopRequireDefault(_note);

var _delete2 = require('../templates/delete.html');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    confirmDelete: function confirmDelete() {
        ...
        var self = this;
        var options = {
            template: _delete3.default,
            handler: this.delete,
            obj: self
        };
        var channel = _vendor.Radio.channel('basic');
...
},{"../../vendor/vendor":27,"../models/Note":6,"../templates/delete.html":7,"../templates/note.html":10}],19:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Marionette.CollectionView.extend({
    childView: _Note2.default,
    tagName: "tbody"
});

},{"../../vendor/vendor":27,"./Note":18}],20:[function(require,module,exports){
'use strict';
...
var _notes = require('../templates/notes.html');

var _notes2 = _interopRequireDefault(_notes);

var _Notes = require('../views/Notes');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    initialize: function initialize(options) {
        ...
        _vendor.Radio.channel('basic').on('collection:fetch', this.updateLayout, this);
        _vendor.Radio.channel('basic').on('collection:filter', this.updateLayout, this);
    },
    ...
    onRender: function onRender() {
        this.notes = new _Notes2.default({ collection: this.collection });
    ...
    onBeforeDestroy: function onBeforeDestroy() {
        console.log("destroy");
        _vendor.Radio.channel('basic').off('collection:fetch');
    },
...
},{"../../vendor/vendor":27,"../templates/notes.html":12,"../views/Notes":19}],21:[function(require,module,exports){
'use strict';
...
var _notification = require('../templates/notification.html');
...
exports.default = _vendor.Marionette.View.extend({
    template: _notification2.default,
    ui: {
        "close": ".dismiss"
    },
    events: {
        'click @ui.close': function clickUiClose(e) {
            e.preventDefault();
            _vendor.Radio.channel('basic').trigger('notification:close');
        }
    }
});

},{"../../vendor/vendor":27,"../templates/notification.html":13}],22:[function(require,module,exports){
...
},{"backbone":24,"backbone.radio":23,"underscore":26}],23:[function(require,module,exports){
...
exports.Radio = exports.Marionette = exports.Backbone = exports.$ = exports._ = undefined;
...
var _backbone5 = require('backbone.marionette');
...
exports.Marionette = _backbone6.default;
exports.Radio = _backbone4.default;

},{"backbone":24,"backbone.marionette":22,"backbone.radio":23,"jquery":25,"underscore":26}]},{},[3]);
